...
app.config['SECRET_KEY'] = os.environ.get('FLASK_SECRET_KEY',
                                          'your_default_super_secret_key_for_development')  # IMPORTANT: Set a strong secret key
app.config[
    'SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:Hitm%40nMysql#2025@localhost/booksonn'
# Example for Oracle (you'd need cx_Oracle installed):
# app.config['SQLALCHEMY_DATABASE_URI'] = 'oracle+cx_oracle://user:password@TNS_ENTRY_NAME'
